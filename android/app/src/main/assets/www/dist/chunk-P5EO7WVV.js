...
var pageEntries = {
  index: () => import("./entry-YQSY6LXL.js").then((m) => PlatformBridge.waitForInterface(m.indexMain)),
  home: () => import("./home-HK2FWFZW.js").then((m) => PlatformBridge.waitForInterface(m.homeMain)),
  editor: () => import("./editor-336KARJP.js").then((m) => PlatformBridge.waitForInterface(m.editorMain)),
  gettingStarted: () => import("./gettingstarted-WDLKRFYF.js").then((m) => PlatformBridge.waitForInterface(m.gettingStartedMain)),
  inappAbout: () => import("./inapp-AIO5SXLR.js").then((m) => m.inappAbout()),
  inappInterfaceGuide: () => import("./inapp-AIO5SXLR.js").then((m) => m.inappInterfaceGuide()),
  inappPaintEditorGuide: () => import("./inapp-AIO5SXLR.js").then((m) => m.inappPaintEditorGuide()),
  inappBlocksGuide: () => import("./inapp-AIO5SXLR.js").then((m) => m.inappBlocksGuide())
};
function bootApp() {
  if (!window.scratchjr) {
...
//# sourceMappingURL=chunk-P5EO7WVV.js.map
