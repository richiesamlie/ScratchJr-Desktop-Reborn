...
function inappAbout() {
  ...
  gn("aboutDescription").innerHTML = Localization.localize("ABOUT_DESCRIPTION") + "<br/><br/>" + Localization.localize("ABOUT_INSPIRED_BY");
  ...
  gn("aboutWhoCreatedDescription").innerHTML = Localization.localize("ABOUT_WHO_CREATED_DESCRIPTION");
  gn("aboutWhoSupported").textContent = Localization.localize("ABOUT_WHO_SUPPORTED");
  gn("aboutWhoSupportedDescription").innerHTML = Localization.localize("ABOUT_WHO_SUPPORTED_DESCRIPTION");
...
//# sourceMappingURL=inapp-EKH5FT54.js.map
