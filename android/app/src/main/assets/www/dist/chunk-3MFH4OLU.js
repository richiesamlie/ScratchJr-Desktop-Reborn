...
var Palette = class _Palette {
  ...
  static dropBlockFromPalette(e, element) {
    e.preventDefault();
    console.error("TRACE dropBlockFromPalette entered");
    console.error("TRACE landing=" + _Palette.getLandingPlace(element, e));
...
//# sourceMappingURL=chunk-3MFH4OLU.js.map
