...
var pageEntries = {
  index: () => import("./entry-LR7F4FXR.js").then((m) => iOS.waitForInterface(m.indexMain)),
  home: () => import("./home-E4ZIPDQB.js").then((m) => iOS.waitForInterface(m.homeMain)),
  editor: () => import("./editor-HIFZ2NAG.js").then((m) => iOS.waitForInterface(m.editorMain)),
  gettingStarted: () => import("./gettingstarted-PW3G4DTO.js").then((m) => iOS.waitForInterface(m.gettingStartedMain)),
  inappAbout: () => import("./inapp-EKH5FT54.js").then((m) => m.inappAbout()),
  inappInterfaceGuide: () => import("./inapp-EKH5FT54.js").then((m) => m.inappInterfaceGuide()),
  inappPaintEditorGuide: () => import("./inapp-EKH5FT54.js").then((m) => m.inappPaintEditorGuide()),
  inappBlocksGuide: () => import("./inapp-EKH5FT54.js").then((m) => m.inappBlocksGuide())
};
function bootApp() {
  if (!window.scratchjr) {
...
//# sourceMappingURL=chunk-MRV4NCDN.js.map
