...
var pageEntries = {
  index: () => import("./entry-TDIDXRK5.js").then((m) => PlatformBridge.waitForInterface(m.indexMain)),
  home: () => import("./home-QEMQZRP5.js").then((m) => PlatformBridge.waitForInterface(m.homeMain)),
  editor: () => import("./editor-CUT2GA7V.js").then((m) => PlatformBridge.waitForInterface(m.editorMain)),
  gettingStarted: () => import("./gettingstarted-2NBKQVL3.js").then((m) => PlatformBridge.waitForInterface(m.gettingStartedMain)),
  inappAbout: () => import("./inapp-NCYJ3SP6.js").then((m) => m.inappAbout()),
  inappInterfaceGuide: () => import("./inapp-NCYJ3SP6.js").then((m) => m.inappInterfaceGuide()),
  inappPaintEditorGuide: () => import("./inapp-NCYJ3SP6.js").then((m) => m.inappPaintEditorGuide()),
  inappBlocksGuide: () => import("./inapp-NCYJ3SP6.js").then((m) => m.inappBlocksGuide())
};
function bootApp() {
  ...
  if (typeof window !== "undefined" && window.scratchjr && window.scratchjr.onAppClose) {
...
//# sourceMappingURL=chunk-KMQUMTUL.js.map
