...
var Library = class _Library {
  ...
  static layoutHeader() {
    ...
    libFrame.appendChild(fileInput);
  ...
  static sanitizeImportName(fileName) {
    ...
    return clean.length > 0 ? clean : Localization.localize("LIBRARY_CHARACTER");
  }
...
var ScratchJr = class _ScratchJr {
  ...
  static flippage() {
    ...
    function doNext() {
      PlatformBridge.cleanassets("svg", _ScratchJr.switchPage);
    }
  }
  static switchPage() {
...
//# sourceMappingURL=chunk-BDHT22TD.js.map
