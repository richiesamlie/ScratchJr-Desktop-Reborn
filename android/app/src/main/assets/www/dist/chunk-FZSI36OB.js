...
var pageEntries = {
  index: () => import("./entry-VOK3TLJN.js").then((m) => PlatformBridge.waitForInterface(m.indexMain)),
  home: () => import("./home-NEAK5E7B.js").then((m) => PlatformBridge.waitForInterface(m.homeMain)),
  editor: () => import("./editor-LSKAYI6Y.js").then((m) => PlatformBridge.waitForInterface(m.editorMain)),
  gettingStarted: () => import("./gettingstarted-WDLKRFYF.js").then((m) => PlatformBridge.waitForInterface(m.gettingStartedMain)),
  inappAbout: () => import("./inapp-FTA2LSYB.js").then((m) => m.inappAbout()),
  inappInterfaceGuide: () => import("./inapp-FTA2LSYB.js").then((m) => m.inappInterfaceGuide()),
  inappPaintEditorGuide: () => import("./inapp-FTA2LSYB.js").then((m) => m.inappPaintEditorGuide()),
  inappBlocksGuide: () => import("./inapp-FTA2LSYB.js").then((m) => m.inappBlocksGuide())
};
function bootApp() {
  if (!window.scratchjr) {
...
//# sourceMappingURL=chunk-FZSI36OB.js.map
