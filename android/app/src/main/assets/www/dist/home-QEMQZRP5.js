...
var Home = class _Home {
  ...
  static init() {
    ...
    frame.ontouchstart = _Home.handleTouchStart;
    frame.ontouchend = _Home.handleTouchEnd;
  ...
  static handleTouchStart(e) {
    ...
    function holdit() {
      ...
      frame.ontouchmove = _Home.handleMove;
      var repeat = function() {
        if (_Home.actionTarget) {
  ...
  static performAction(e) {
    ...
    switch (_Home.getAction(e)) {
      ...
      case "delete":
        ...
        import("./Project-NDHO63VF.js").then((m) => {
  ...
  static duplicateProject(projectId) {
    ...
    IO.query(PlatformBridge.database, json, function(res) {
      try {
        ...
        var source = IO.parseProjectData(rawRows[0]);
  ...
  static gotoEditor(md5) {
    if (!md5 || Number(md5) <= 0) {
      ...
      import("./Alert-JFW33H3U.js").then((m) => {
  ...
  static importSjrFile(file) {
    ...
    file.arrayBuffer().then(function(buf) {
      ...
      if (frame3) {
        Alert.open(frame3, frame3, errorMessage, "#ff0000");
      }
    });
  }
...
//# sourceMappingURL=home-QEMQZRP5.js.map
